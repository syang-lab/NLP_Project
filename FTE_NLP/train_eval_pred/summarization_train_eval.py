...
def summarization_train_eval(json_filename,
                             model_checkpoint,
                             train_eval_split,
                             train_batch_size,
                             eval_batch_size,
    ...
    #save_check_point_model = '../experiments/model_bucket/summarization/t5/'
    ...
    training_eval_dataset = summarization_data(test_data, tokenizer, domain_adaption=False, wwm_prob=0.1)
...
if __name__=="__main__":
    ...
    summarization_train_eval(json_filename,
                             model_checkpoint,
                             train_eval_split,
                             train_batch_size,
                             eval_batch_size,
